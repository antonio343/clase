l="""kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
siete=letra+6
for i in l:
    if (may.find(l[uno]) and may.find(l[dos]) and may.find(l[tres]) and mini.find(l[cuatro]) and may.find(l[cinco]) and may.find(l[seis]) and may.find(l[siete])):    
        print(l[uno],l[dos],l[tres],l[cuatro,l[cinco],l[seis],l[siete]])
    letra+=1
